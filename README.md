...
# Context
  ...
  Image 1: graph of AUC vs Timepoint separated into bins of similar population
...
<img width="135" height="168" alt="Screenshot 2026-08-11 at 9 55 25 PM" src="https://github.com/user-attachments/assets/43e2236a-8343-4b16-8fbb-51efcafdeea8" />
  ...
  Image 2: screenshot of top Dead-end predictors from one classifier run. Fibroblast genes Col5a2 and Pdgfra are present
  ...
  Image 3: image of textbook Y shape demonstrating two-fate structure. Other relationships are much smaller and characterized by comparatively weaker lines on PAGA graph
